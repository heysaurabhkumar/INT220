<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Indian Cuisine</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/IndianCuisine" class="hvr-grow">Home</a></li>
		        <li><a href="/IndianCuisine/about-Indian-Cuisine.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/IndianCuisine">Home</a></li>
	        <li><a href="/IndianCuisine/about-Indian-Cuisine.php">About Us</a></li>
